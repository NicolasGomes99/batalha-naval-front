...
import { Trophy, Skull, Target, Medal, ArrowLeft } from "lucide-react";
import Image from "next/image";

/**
 * Stat Card Component (Reaproveitado do perfil original)
 */
...
export default function PlayerProfilePage() {
    ...
    // Transformando os códigos nas instâncias de medalhas e ordenando
                ...
                <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-5">
                            <div className="w-24 h-24 rounded-full overflow-hidden border-[3px] border-cyan-400 shadow-lg shadow-cyan-500/20">
